...
// email — this bare page is the fallback for the rare visitor who has no
// link at all, just their order number. Also reachable on-domain via
// Shopify's App Proxy at giftygram.ae/apps/track (see
// components/track-search-form.tsx for the client-side navigation half of
// making that transparent).
